...
app.use(
  session({
    store: MongoStore.create({
      mongoUrl: `mongodb+srv://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/${DB_NAME}?retryWrites=true&w=majority`,
      mongoOptions,
    }),
  ...
  app.use(
    ...
    graphqlHTTP({
      ...
      rootValue: {
        ...
        postProducto: postProductos,
        updateProducto: editProductos,
        deleteProducto: deleteProductos,
      },
      graphiql: true,
    })
  );
